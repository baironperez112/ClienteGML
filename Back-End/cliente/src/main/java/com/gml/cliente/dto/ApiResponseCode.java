...
public enum ApiResponseCode {
	 ...
	 * Error cuando no existe el valor de un parametro
	 */
	GENERIC_REGISTRO_NOT_FOUND("E003", "No se encontró el registro consultado.  ", HttpStatus.NOT_FOUND),

	/**
	 * Error cuando no existe el valor de un parametro
	 */
	ERROR_REGISTRO_EXISTENTE("E004", "El registro ya es existente  ", HttpStatus.CONFLICT);
